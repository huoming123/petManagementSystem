...
import com.design.petStoreManagement.pojo.Announcement;
import com.design.petStoreManagement.mapper.AnnouncementMapper;
import com.design.petStoreManagement.service.AnnouncementService;
...
public class AnnouncementServiceImpl implements AnnouncementService {
    ...
    public RestFulBean<String> insert(Announcement announcement) {
        if(announcement.getAnnouncement()==null){
            return RestFulBean.error("公告内容不能为空");
        }
